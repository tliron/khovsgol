_This is the project description from the old Python-based version of Khövsgöl. The complete source code for it is still available in the "python" git repository. There's lots of useful code there!_
